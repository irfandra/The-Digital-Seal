...
export default function HomeScreen() {
  ...
  function renderCollectionCard({ item }: { item: typeof collections[0] }) {
    return (
    ...
    <>
      ...
      <View style={styles.tabs}>
        ...
        >
          <Text style={[
            styles.tabText, 
            activeTab === 'Collections' && styles.activeText
          ]}>
            Collections
          </Text>
        </TouchableOpacity>
        ...
        >
          <Text style={[
            styles.tabText, 
            activeTab === 'Brands' && styles.activeText
          ]}>
            Brands
          </Text>
        </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  // NEW: Tablet spacer for proper column alignment
  tabletSpacer: {
    height: 24,
  },
  // NEW: Footer spacer for proper scrolling space
  footerSpacer: {
